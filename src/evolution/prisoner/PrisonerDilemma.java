...
public class PrisonerDilemma {
    ...
    public static int roundsMin = 100;
    public static int roundsMax = 200;
    ...
    public static void main(String[] args) {
        ...
        for(int rep = 0 ; rep < 100;rep ++){
            ...
            for (int j = 0; j < scores.length; j++) {
                ...
                //System.out.println();
                if(strategies[maxIdx].getName().equals("Fuck me? Fuck you!")){
                    posSum+=j;
                }
                scores[maxIdx] = Integer.MIN_VALUE;
            }
            System.out.println("Avg pos : "+(posSum/(1+rep)));
        }
